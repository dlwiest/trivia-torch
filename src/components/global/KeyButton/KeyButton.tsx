...
const KeyButton = () => {
    ...
    return (
        <button
            ...
            onClick={() => toggleModal()}
        >
            <KeyIcon className="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark:group-hover:fill-zinc-300/20 dark:group-hover:stroke-zinc-300 dark:fill-zinc-300/10 dark:stroke-zinc-400" />
        </button>
    );
};
